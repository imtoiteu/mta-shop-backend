...
//
//	@Autowired
//	private CartDetailBusiness cartDetailBusiness;
//
//	@GetMapping("cart/{id}")
//	public ResponseEntity<List<CartDetail>> getByCartId(@PathVariable("id") Long id) {
//		List<CartDetail> list_cart = cartDetailBusiness.getByCartId(id);
//		if(list_cart != null) {
...
//		CartDetail cartDetail = cartDetailBusiness.getOne(id);
//		if(cartDetail != null) {
//			return ResponseEntity.notFound().build();
//		}
...
//
//		CartDetail cartDetail = cartDetailBusiness.post(detail);
//		if (cartDetail == null) {
//			return ResponseEntity.notFound().build();
//		}
//		return ResponseEntity.ok(cartDetail);
...
////		}
////		return ResponseEntity.ok(cartDetailRepository.save(detail));
//		CartDetail cartDetail = cartDetailBusiness.put(detail);
//		if(cartDetail == null) {
//			return ResponseEntity.notFound().build();
//		}
//
...
//
//	    CartDetail cartDetail = cartDetailBusiness.deleteById(id);
//	    if (cartDetail == null) {
//	        return ResponseEntity.notFound().build();
//	    }
//	    return ResponseEntity.ok().build();
...
import vn.fs.repository.CartDAO;
import vn.fs.repository.ProductDAO;
import vn.fs.business.CartDetailBusiness;
