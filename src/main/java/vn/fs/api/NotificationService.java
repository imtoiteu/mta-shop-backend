...
import vn.fs.business.NotificationBusiness;
...
//		List<Notification> notifications = notificationBusiness.getAllNotifications(offset, limit);
...
//		Notification createdNotification = notificationBusiness.createNotification(notification);
...
//		Notification updatedNotification = notificationBusiness.markAsRead(id);
